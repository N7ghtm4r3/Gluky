...
/**
 * The {@code Launcher} class is useful to launch <b>Gluky's backend service</b>
 *
...
@ComponentScan(value = {"com.tecknobit.gluky.*", "com.tecknobit.equinoxbackend.environment.configuration"})
